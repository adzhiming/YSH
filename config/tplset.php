...
<tr><td><strong>操作：</strong></td><td><a href="{$surelink}"><span style="3px 5px 3px 5px;backgroud:#f60;color:#fff;">确认制作</span></a>      <a href="{$closelink}"><span style="">取消制作</span></a></td></tr>
  ...
  'phoneunorder' => '【阜新外卖】{$dno}订单取消,原因{$reason},取消时间{time()|date_format:"%Y-%m-%d %H:%M:%S"}',
  ...
  'noticesend' => '“{$shopname}”的外卖配送员正火速赶来送餐。在此【阜新外卖】祝您用餐愉快！',
  'noticeunmake' => '您在【阜新外卖】的订单{$dno}，由于“{$shopname}”订单爆满，来不及制作。请选其他餐厅，给您带来不便敬请谅解',
  'noticeunback' => '退款失败.请您咨询客服',
  'noticeback' => '退款成功',
)?>