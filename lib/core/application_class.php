...
class myapp
{
	...
	public function getkey(){
		return 'dsafyukasdasdgfasdwouaedvajdfsflshdsfhjds';
	}
	...
	public function run($setindex='')
	{
  	  ...
  	  //   $url=  IUrl::getUrl();//'http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"];   获取当前网页
  	   ...
  	   /*  if($this->getkey() != $sitekey){
  	    ...
  	    $hostcheck = array('localhost','http://www.shs2013.com','www.shs2013.com','shs2013.com');
  	   ...
  	   if($controller == 'site' && $Taction == 'index'){ 
  	       if(is_mobile_request() && strpos($_SERVER["HTTP_USER_AGENT"],'MicroMessenger')){   
