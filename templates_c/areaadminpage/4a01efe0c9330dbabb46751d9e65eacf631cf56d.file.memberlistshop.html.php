<?php /* Smarty version Smarty-3.1.10, created on 2017-09-21 01:21:50
         compiled from "F:\www\YSH\templates\areaadminpage\member\memberlistshop.html" */ ?>
<?php /*%%SmartyHeaderCode:3131259c2a3aef3feb5-39200963%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a01efe0c9330dbabb46751d9e65eacf631cf56d' => 
    array (
      0 => 'F:\\www\\YSH\\templates\\areaadminpage\\member\\memberlistshop.html',
      1 => 1483088996,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3131259c2a3aef3feb5-39200963',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2a3b06cc2d7_32862499',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2a3b06cc2d7_32862499')) {function content_59c2a3b06cc2d7_32862499($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'F:\\www\\YSH\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
	...
	<div class="managShopBox">
		<div class="managShopMain">
			<div class="managShopClas">
				<ul>
					<li class="maShClaA"><a href="javascript:;">商家会员列表</a></li>
				</ul>
			</div>
			<div class="managShopSeaBox">
				<div class="managShopSeaL">
				<form method="post" name="form1" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/member/module/memberlistshop"),$_smarty_tpl);?>
">
					<ul>
 						<li><span>用户名：</span><input type="username"  name="username" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['username']->value)===null||$tmp==='' ? '' : $tmp);?>
" placeholder=""></li>
						<li><span>手机：</span><input type="text"  name="phone" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['phone']->value)===null||$tmp==='' ? '' : $tmp);?>
" placeholder="">
						<input type="submit" value="提交查询" class="managBut">
						<a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/member/module/addmember"),$_smarty_tpl);?>
"><input type="button" value="添加商家会员" class="managBut" /></a>
						</li>
					</ul>
				</form>
				</div>
				...
				<table>
					<thead>
						<tr>
							...
							<td width="206">登录时间</td>
							<td width="206">创建时间</td>
							<td width="206">登录IP</td>
							<td width="127">余额</td>
							<td width="127">积分</td>
							<td width="99">操作</td>
						</tr>
...
?> 
						<tr>
							...
							<td><?php echo $_smarty_tpl->tpl_vars['items']->value['loginip'];?>
</td>
...
"></a>
								<a  onclick="return remind(this);" class="icon_close01" href="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/member/module/delmember/id/".((string)$_smarty_tpl->tpl_vars['items']->value['uid'])."/datatype/json"),$_smarty_tpl);?>
"></a>
							</td>
						</tr>
						<?php } ?>
