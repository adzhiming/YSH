<?php /* Smarty version Smarty-3.1.10, created on 2017-09-21 01:21:55
         compiled from "F:\www\YSH\templates\areaadminpage\order\ordertotal.html" */ ?>
<?php /*%%SmartyHeaderCode:2503059c2a3b3c292a9-77785225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'baef6aec0ef3027cab1e1425eafc627d2677e052' => 
    array (
      0 => 'F:\\www\\YSH\\templates\\areaadminpage\\order\\ordertotal.html',
      1 => 1483089000,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2503059c2a3b3c292a9-77785225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c2a3b4254d96_66952665',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c2a3b4254d96_66952665')) {function content_59c2a3b4254d96_66952665($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'F:\\www\\YSH\\lib\\Smarty\\libs\\plugins\\modifier.date_format.php';
	...
	<div class="managShopBox">
		<div class="managShopMain">
			<div class="managShopClas">
				<ul>
					<li class="maShClaA"><a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/order/module/ordertotal"),$_smarty_tpl);?>
">网站订单</a></li>
					<li><a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/order/module/orderyjin"),$_smarty_tpl);?>
">店铺订单</a></li>
				</ul>
			</div>
			<div class="ordManagQuery">
			<form method="post" name="form1" action="<?php echo FUNC_function(array('type'=>'url','link'=>"/areaadminpage/order/module/ordertotal"),$_smarty_tpl);?>
">
				<ul>
					<li><span>查询类型：</span>
				...
				<table>
					<thead>
						<tr>
							...
							<td width="184">订单数量</td>
							<td width="364">订单金额（元）</td>
							<td width="272">抵扣总积分</td>
						</tr>
					</thead>
					<tbody>
...
?> 
						<tr>
							...
							<td><?php echo $_smarty_tpl->tpl_vars['buyerstatus']->value[$_smarty_tpl->tpl_vars['items']->value['status']];?>
</td>
							<td><?php echo $_smarty_tpl->tpl_vars['items']->value['shuliang'];?>
</td>
							<td><?php echo $_smarty_tpl->tpl_vars['items']->value['allcost'];?>
</td>
							<td><?php echo $_smarty_tpl->tpl_vars['items']->value['scorecost'];?>
</td>
						</tr>
						 <?php } ?> 
