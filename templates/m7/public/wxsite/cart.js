...
function freshcartdata(datas,$payflag){
	...
	datas.content.pscost = newpscost;
	  ...
	  if(datas.content.downcost != 0 ){
			...
			temp_htmls = ' <li><span class="shopdetalistL" style="width:49.8823%;">&nbsp;</span><span class="shopdetalistC shpdetb">优惠立减：</span><span class="shopdetalistR">-￥'+datas.content.downcost+'</span></li>	'; 
			$('#nextshocart').append(temp_htmls);
	  }
