...
{  
   ...
   function cxrulelist(){
       ...
       $cxrulelist = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."rule where  parentid = 1  and  cityid = ".$cityid." order by id asc " );
   ...
   function addcxrule(){
       ...
       $cityid = Mysite::$app->config['default_cityid'];
       $shoplist = $this->mysql->getarr("select id,shopname from ".Mysite::$app->config['tablepre']."shop where is_pass = 1 and admin_id = ".$cityid."   " );
