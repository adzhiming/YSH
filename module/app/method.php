	...
	function newshop(){
		...
		*/
		...
		if(!empty($adcode)){
			...
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id  from ".Mysite::$app->config['tablepre']."shopfast as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom = 1 and b.admin_id = ".$adcode." ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopfast as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id  and b.is_recom != 1 and b.admin_id = ".$adcode."  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
		 }else{
			...
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopfast as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id  and b.is_recom != 1  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");	 
			 ...
			 if(!empty($adcode)){
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopmarket as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom = 1 and b.admin_id = ".$adcode."  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopmarket as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom != 1 and b.admin_id = ".$adcode."  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
			}else{
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopmarket as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom = 1  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype,b.admin_id   from ".Mysite::$app->config['tablepre']."shopmarket as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom != 1  ".$where."   ".$orderarray[$ordertype]."   limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
...
/* 		$newdata['bagcost'] = intval(IFilter::act(IReq::get('bagcost')));
	...
	function getnewconfig(){
		...
		if( $data['color'] == 'red' ){
			$data['color'] = '#FF6E6E'; 			$data['ioscolor'] = '[UIColor colorWithRed:255.0/255.0 green:110.0/255.0 blue:110.0/255.0 alpha:1]';
			$data['colorName'] = '';
		}else{
			if( $data['color'] == 'green' ){ 
				$data['colorName'] = '_'.$data['color'];
				$data['color'] =  '#00CD85';				$data['ioscolor'] = '[UIColor colorWithRed:0/255.0 green:205.0/255.0 blue:110.0/133.0 alpha:1]'; 			}else if( $data['color'] == 'yellow' ){ 
				$data['colorName'] = '_'.$data['color'];
				$data['color'] =  '#FF7600';				$data['ioscolor'] = '[UIColor colorWithRed:0/255.0 green:118.0/255.0 blue:110.0/0 alpha:1]';
			}else{
				$data['colorName'] = '';
				$data['color'] = '#FF6E6E';				$data['ioscolor'] = '[UIColor colorWithRed:255.0/255.0 green:110.0/255.0 blue:110.0/255.0 alpha:1]';
			}
...
//新增函数 
	...
	function newwaimairenindex(){
		...
		首页为你优选商家列表
		*/
		 $fywhere = "  and admin_id=".$this->CITY_ID."   ";  
		 $fywhere = empty($fywhere)?'   and  SQRT((`lat` -'.$lat.') * (`lat` -'.$lat.' ) + (`lng` -'.$lng.' ) * (`lng` -'.$lng.' )) < (`pradiusa`*0.01094-0.01094) ': $fywhere.' and SQRT((`lat` -'.$lat.') * (`lat` -'.$lat.' ) + (`lng` -'.$lng.' ) * (`lng` -'.$lng.' )) < (`pradiusa`*0.01094-0.01094) ';
         $fywhere = Mysite::$app->config['plateshopid'] > 0? $fywhere.' and  id != '.Mysite::$app->config['plateshopid'] .' ':$fywhere;
		 $fyshoplist =   $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where is_pass = 1  and is_open = 1 and isforyou = 1 and endtime > ".time()."  ".$fywhere."   limit  6 ");		
		...
		*/
		...
		if($shopopentype == 0){
			...
			if(strpos($userAgent,"iPhone") || strpos($userAgent,"iPad") || strpos($userAgent,"iPod")){
				...
				$ios_waiting =   Mysite::$app->config['ios_waiting'];
				if($source == 1 && $ios_waiting == true){
				    $tempc = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where is_pass = 1  and is_open = 1 ".$tempwherexxx." and endtime > ".time()."   order by sort asc");
				   }else{
			        $tempc = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where is_pass = 1  and is_open = 1 ".$tempwherexxx." and endtime > ".time()."    and  SQRT((`lat` -".$lat.") * (`lat` -".$lat." ) + (`lng` -".$lng." ) * (`lng` -".$lng." )) < (`pradiusa`*0.01094) order by (`lat` -".$lat.") * (`lat` -".$lat." ) + (`lng` -".$lng." ) * (`lng` -".$lng." ) asc ");
						} 
			}else if(strpos($userAgent,"Android")){
				$tempc = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where is_pass = 1  and is_open = 1 ".$tempwherexxx." and endtime > ".time()."    and  SQRT((`lat` -".$lat.") * (`lat` -".$lat." ) + (`lng` -".$lng." ) * (`lng` -".$lng." )) < (`pradiusa`*0.01094) order by (`lat` -".$lat.") * (`lat` -".$lat." ) + (`lng` -".$lng." ) * (`lng` -".$lng." ) asc ");
			    	}else{
		...
		$strnoopen = implode(",",$noopen);
		$stropen = implode(",",$open);
		$newstrshopid = $stropen.','.$strnoopen;
		$newstrshopid = rtrim($newstrshopid, ",");
		$newwhere = 'id in('.$newstrshopid.') order by field(id,'.$newstrshopid.')';
		$newwheres = 'b.id in('.$newstrshopid.') order by field(b.id,'.$newstrshopid.')';
		...
		if($shopopentype == 0){
			...
			if(strpos($userAgent,"iPhone") || strpos($userAgent,"iPad") || strpos($userAgent,"iPod")){
				...
				$ios_waiting =   Mysite::$app->config['ios_waiting'];
				if($source == 1 && $ios_waiting == true){
					$tempc = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where ".$newwhere. "  limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()."");
						}else{
					$tempc = $this->mysql->getarr("select * from ".Mysite::$app->config['tablepre']."shop where ".$newwhere. "  limit ".$this->pageCls->startnum().", ".$this->pageCls->getsize()." ");
						}
			}else if(strpos($userAgent,"Android")){
	...
	function newwaimairenindexPage(){
		...
		*/
		...
		if($shopopentype == 0){
			...
			$tempdd[] = $this->mysql->getarr("select a.shopid,b.id,b.shopname,b.sellcount,point,pointcount,b.virtualsellcounts,b.is_open,b.starttime,b.pointcount as pointsellcount,lat,lng,a.is_orderbefore,a.limitcost,b.shoplogo,a.is_hot,a.is_com,a.is_new,a.maketime,a.pradius,b.lat,b.lng,a.sendtype,a.pscost,a.pradiusvalue,a.arrivetime,b.address,b.point,b.shoptype  from ".Mysite::$app->config['tablepre']."shopfast as a left join ".Mysite::$app->config['tablepre']."shop as b  on a.shopid = b.id and b.is_recom = 1 ".$where."  ".$newwheres." ".$orderarray[$ordertype]."  ");
